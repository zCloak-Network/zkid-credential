...
function getPublicInput() {
  ...
  return `${Math.floor(new Date(compareDate).getTime() / 1000)}`;
}
...
const option: ZkProgramOption = [['0x2e0e5ba41f58ffdccb9dba906715b9142e40929d80896310906cde392862fc9e'], config];

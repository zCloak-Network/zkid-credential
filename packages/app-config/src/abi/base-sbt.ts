...
export const baseSbtAbi = [
  ...
  { inputs: [], name: 'OnChainRecipientNotSet', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'tokenID', type: 'uint256' },
      { indexed: false, internalType: 'bytes32', name: 'programHash', type: 'bytes32' },
      { indexed: false, internalType: 'uint64', name: 'createdTime', type: 'uint64' },
      { indexed: false, internalType: 'uint64', name: 'expiredTime', type: 'uint64' },
      ...
      { indexed: false, internalType: 'bytes32', name: 'ctypeHash', type: 'bytes32' },
      { indexed: false, internalType: 'string', name: 'sbtLink', type: 'string' }
    ],
    name: 'BindingTransferTokenSuccess',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [
      ...
      { indexed: false, internalType: 'uint64[]', name: 'publicInput', type: 'uint64[]' },
      { indexed: false, internalType: 'uint64[]', name: 'output', type: 'uint64[]' },
      { indexed: false, internalType: 'uint64', name: 'createdTime', type: 'uint64' },
      { indexed: false, internalType: 'uint64', name: 'expiredTime', type: 'uint64' },
      { indexed: true, internalType: 'address', name: 'attester', type: 'address' },
      { indexed: false, internalType: 'address', name: 'claimer', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint64[]', name: 'publicInput', type: 'uint64[]' },
      { internalType: 'bytes32', name: 'ctype', type: 'bytes32' }
    ],
    name: 'checkOnlyTokenID',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function'
  },
  ...
  { inputs: [], name: 'removeAssertionMethod', outputs: [], stateMutability: 'payable', type: 'function' },
